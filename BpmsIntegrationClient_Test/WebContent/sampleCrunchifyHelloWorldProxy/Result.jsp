...
<jsp:useBean id="sampleCrunchifyHelloWorldProxyid" scope="session" class="br.com.unimedfortaleza.bpmsintegration.soap.CrunchifyHelloWorldProxy" />
<%
...
case 10:
        gotMethod = true;
        br.com.unimedfortaleza.bpmsintegration.soap.CrunchifyHelloWorld getCrunchifyHelloWorld10mtemp = sampleCrunchifyHelloWorldProxyid.getCrunchifyHelloWorld();
